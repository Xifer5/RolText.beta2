...
export const ACHIEVEMENTS = [
  ...
  { id:"all_quests",    icon:"🏅",  rarity:"legendary", title:{ en: "Savior of Aetheria", es: "Héroe de Aetheria" }, desc:{ en: "Complete all quests.", es: "Completa todas las misiones." },            check:()=>Object.values(QUEST_DATA).every(q=>gameState.quests?.[q.id]==="completed") },
