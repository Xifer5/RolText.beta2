...
function setupDismissShortcuts() {
  document.addEventListener("keydown", (event) => {
    ...
    // El modal de evento de viaje bloquea el movimiento mientras está abierto;
    // cerrarlo con ESC saltaba sus handlers y dejaba isProcessingMove en true para siempre
    if (topModal.id === "travelEventModal" && gameState.isProcessingMove) {
